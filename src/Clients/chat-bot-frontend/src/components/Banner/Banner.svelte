...
<div class="w-full flex justify-center items-center pt-5">
  <div
    class="relative text-white mx-auto text-center overflow-hidden max-h-[480px] max-w-[928px] w-2/3 opacity-90"
  >
    <img
      src="banner.webp"
    ...
    <div class="relative z-10 p-12 md:p-24 justify-center items-center">
      ...
      <div class="relative shadow md:block">
        ...
        />
        <button
          class="absolute inset-y-0 right-0 mr-1 mt-1 mb-1 flex items-center bg-[#F5C754] text-gray-900 text-sm font-bold px-4
                rounded shadow-md transition duration-300 ease-in-out transform hover:scale-10 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none disabled:cursor-not-allowed"
